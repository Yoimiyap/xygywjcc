...
<!-- 最后加五个空格，防止浏览器滚动条遮挡 -->
<span style="float: right"><a href="admin.php" target="_blank">后台管理</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></div>
<div class="zhuti">
<!-- 上传方式1，js提交 -->
<div id="scui1">
...
<b>广告：</b><br/><img src="adimg.png" id="adimg" width="100%" max-width="100%" onclick="window.open('https://blog.xiaoyonggaoya.tbit.top')" alt="广告"><br/>
</div>
<div class="dilan">
